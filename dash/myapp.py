...
# from migrations import transaction, feedback  
# import migrations
...
# migrate = Migrate(myapp, migrations)
...
connection = psycopg2.connect(host = 'postgreshost', port='5433', database = 'frauddetection', user = 'postgres', password = 'azbycx567')
...
app.layout = html.Div(children=[
    ...
    html.Div(  #division 1, the head
        html.H2(children='RTFS: a real-time fraud detection system with feedback!',
...
def rejectTransaction(n_clicks):
    if n_clicks is not None and n_clicks > 0:
        connection = psycopg2.connect(host = 'postgreshost', port='5433', database = 'frauddetection', user = 'postgres', azbycx567 = 'azbycx567')
        cursor = connection.cursor()
